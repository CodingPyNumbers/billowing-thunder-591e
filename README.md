...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/billowing-thunder-591e
```

A live public deployment of this template is available at [https://billowing-thunder-591e.templates.workers.dev](https://billowing-thunder-591e.templates.workers.dev)
